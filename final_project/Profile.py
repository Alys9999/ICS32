...
class Profile:
    ...
    def __init__(self, dsuserver='168.235.86.101', port=2021,username='UUUUUUUser', password='pw'):
    ...
    # renew the latest info 
    def renew_info(self, dsuserver, port, username, password):
